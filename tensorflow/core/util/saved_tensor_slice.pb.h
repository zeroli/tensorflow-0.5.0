...
class SavedSliceMeta PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr SavedSliceMeta(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class SavedTensorSliceMeta PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr SavedTensorSliceMeta(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class SavedSlice PROTOBUF_FINAL :
 ...
 public:
  ...
  ~SavedSlice() override;
  explicit constexpr SavedSlice(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class SavedTensorSlices PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr SavedTensorSlices(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void SavedSliceMeta::set_name(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void SavedSlice::set_name(ArgT0&& arg0, ArgT... args) {
...
inline ::tensorflow::TensorSliceProto* SavedSlice::_internal_mutable_slice() {
  ...
  if (slice_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::TensorSliceProto>(GetArena());
    slice_ = p;
  }
  return slice_;
}
...
inline ::tensorflow::SavedTensorSliceMeta* SavedTensorSlices::_internal_mutable_meta() {
  ...
  if (meta_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::SavedTensorSliceMeta>(GetArena());
    meta_ = p;
  }
  return meta_;
}
...
inline ::tensorflow::SavedSlice* SavedTensorSlices::_internal_mutable_data() {
  ...
  if (data_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::SavedSlice>(GetArena());
    data_ = p;
  }
  return data_;
}
