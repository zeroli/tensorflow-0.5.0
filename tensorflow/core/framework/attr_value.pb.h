...
inline void AttrValue::set_s(ArgT0&& arg0, ArgT... args) {
  ...
  value_.s_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline void AttrValue::_internal_set_s(const std::string& value) {
  ...
  value_.s_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline std::string* AttrValue::release_s() {
  ...
  if (_internal_has_s()) {
    clear_has_value();
    return value_.s_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  } else {
    return nullptr;
  }
}
...
inline void AttrValue::set_placeholder(ArgT0&& arg0, ArgT... args) {
  ...
  value_.placeholder_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline void AttrValue::_internal_set_placeholder(const std::string& value) {
  ...
  value_.placeholder_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline std::string* AttrValue::release_placeholder() {
  ...
  if (_internal_has_placeholder()) {
    clear_has_value();
    return value_.placeholder_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  } else {
    return nullptr;
  }
}
...
inline void NameAttrList::set_name(ArgT0&& arg0, ArgT... args) {
